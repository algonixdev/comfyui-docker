variable "DOCKER_REGISTRY_URL" {
    default = "ghcr.io/algonixdev/"
}
variable "COMFYUI_VERSION" {
    default = "master"
}
variable "CPU_BASE_IMAGE" {
    default = "ghcr.io/algonixdev/comfy-base/cpu-core:py3.12-torch2.10.0-cpu"
}
variable "AMD_BASE_IMAGE" {
    default = "ghcr.io/algonixdev/comfy-base/amd-core:py3.12-torch2.10.0-rocm7.1.1"
}
variable "NVIDIA_BASE_IMAGE" {
    default = "ghcr.io/algonixdev/comfy-base/nvidia-full:py3.12-torch2.10.0-cuda13.0.2"
}
